...
class Dnk_Sms_Model_Shipment extends Mage_Core_Model_Config_Data
{
    public function save()
    {
        ...
        {
            Mage::getSingleton('core/session')->addError("Please enter sms template with status Approved for Order Shipment");  
