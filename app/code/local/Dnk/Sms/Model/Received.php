...
class Dnk_Sms_Model_Received extends Mage_Core_Model_Config_Data
{
    public function save()
    {
        ...
        {
            Mage::getSingleton('core/session')->addNotice("Please enter sms template with status Approved for RMA Received");    
        }else{
