...
class Dnk_CustomCatalog_Block_Adminhtml_Widget_Grid_Column_Renderer_Number extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
		...
		if ($rateId != '' && $rates != '') {
			...
			$html = '<input type="text" value="'.$value.'" name="number" class="input-text validate-number" disabled="">';
		} else {
			$html = '<input type="text" value="" name="number" class="input-text validate-number" disabled="" >';
		}
		return $html;
    }
