...
class Dnk_Sms_Model_Complete extends Mage_Core_Model_Config_Data
{
    public function save()
    {
        ...
        {
            Mage::getSingleton('core/session')->addNotice("Please enter sms template with status Approved for RMA Complete");    
        }else{
